...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM SubMenu_Right_tbl WHERE SubID = $id";
                    ...
                    <div class="table-responsive small">
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                // Assuming $selectedMainID contains the ID of the option to be preselected
                                $selectedMainID = $row['MainID']; // Assuming 'MainID' is the column name in the SubMenu_Right_tbl

                                ?>
                                <select class="form-select" id="MainID" name="MainID">
                                    <option value="">Main Category</option>
                                    <?php
                                    while ($mainRow = mysqli_fetch_assoc($mainCategoryResult)) {
                                        $optionValue = $mainRow['MainID'];
                                        $optionTitle = $mainRow['title'];
                                        $selected = ($optionValue == $selectedMainID) ? 'selected' : '';
