<?php 
    ...
    if(isset($_GET['id']) && !empty($_GET['id'])) {
        $id = $_GET['id'];
        $query = "SELECT * FROM About_tbl WHERE id = $id";
      ...
      <div class="table-responsive small">
        ...
        <div class="mb-3 px-1"> 
            ...
            <select class="form-select" id="MainCategory" name="MainCategory">
                ...
                while ($rowCategory = mysqli_fetch_assoc($CategoryResult)) {
                    echo "<option value='" . $rowCategory['MainCategoryID'] . "'>" . $rowCategory['mainCategoryTitleKH'] . "</option>";
                }
                ?>
            </select>
            </div>
        ...
        <input type="file" class="form-control" id="imagedetails_1" name="imagedetails_1" value="<?php echo $row['imagedetails_1']; ?>">
        </div>
        ...
        <?php for ($i = 2; $i <= 11; $i++) : ?>
            ...
            <input type="file" class="form-control" name="imagedetails_<?php echo $i; ?>" value="<?php echo $row['imagedetails_' . $i]; ?>">
            </div>
        <?php endfor; ?>
        <?php } ?>
        </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // Preview image
        $('#imagedetails_11').change(function() {
